...
const Homepage: React.FC = () => {
  ...
  return (
    <>
      <div className="bg-custom-pattern min-h-screen text-white font-sans overflow-hidden">
  {/* Navbar */}
  <nav className="flex flex-wrap justify-between items-center h-auto max-w-7xl mx-auto px-4 py-4 sm:py-6 relative top-14 z-10">
    <h1 className="text-xl sm:text-2xl font-bold cursor-pointer ml-2">
      <a href="#home" className="hover:text-gray-300">Boldo</a>
    </h1>
    <div className="flex flex-wrap justify-center sm:justify-end items-center space-x-4 sm:space-x-6 mt-2 sm:mt-0">
  ...
  >
    ...
    <span>Success</span>
      ...
      <div className="mx-auto max-w-7xl px-4 relative text-start">
        ...
        <div className="flex flex-wrap justify-center sm:justify-between mt-12 gap-6 sm:gap-0">
          {services.map((service, index) => (
            <div
              key={index}
              className="flex-1 max-w-full sm:max-w-[calc(33.333%-1rem)] px-4 text-center sm:text-left"
            >
              <img
              ...
              <p
                className={`text-[14px] sm:text-[20px] leading-[24px] sm:leading-[28px] transition-all duration-300 ${
                  expanded === index
                    ? "line-clamp-none"
